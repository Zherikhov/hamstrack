...
| Method | Path | Auth | Description |
|---|---|---|---|
| `POST` | `/auth/register` | — | Create an account; sends a verification email. `201`. `422` when `password` is [a value this project published](#a-password-this-project-published--a-422) |
